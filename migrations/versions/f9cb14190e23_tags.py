...
Revision ID: f9cb14190e23
Revises: 
Create Date: 2018-05-12 19:50:16.531754
...
def upgrade():
    ...
    op.create_index(op.f('ix_tag_tags'), 'tag', ['tags'], unique=True)
...
def downgrade():
    ...
    op.drop_table('user')
    op.drop_index(op.f('ix_tag_tags'), table_name='tag')
    op.drop_table('tag')
    # ### end Alembic commands ###
